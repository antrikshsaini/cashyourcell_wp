...
<div id="header">
  <div class="header-menu <?php if( get_theme_mod( 'vw_mobile_app_sticky_header', false) == 1 || get_theme_mod( 'vw_mobile_app_stickyheader_hide_show', false) == 1) { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-8 align-self-lg-center">
          <div class="logo">
            ...
            <?php if( get_theme_mod('vw_mobile_app_logo_title_hide_show',true) == 1){ ?>
              ...
              <?php endif; ?>
            <?php }?>
            <?php if( get_theme_mod('vw_mobile_app_tagline_hide_show',false) == 1){ ?>
              <?php
