...
<form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input type="search" class="search-field" placeholder="<?php echo esc_attr( get_theme_mod('vw_mobile_app_search_placeholder', __('Search', 'vw-mobile-app')) ); ?>" value="<?php echo esc_attr(get_search_query()) ?>" name="s">
	</label>
