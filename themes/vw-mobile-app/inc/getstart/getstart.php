    ...
    <div class="tab-sec">
		...
		<div id="product_addons_editor" class="tabcontent">
			<?php if(!class_exists('IEPA_Loader')){
				$plugin_ins = VW_Mobile_App_Plugin_Activation_Woo_Products::get_instance();
				$vw_mobile_app_actions = $plugin_ins->recommended_actions;
				?>
				<div class="vw-mobile-app-recommended-plugins">
					    <div class="vw-mobile-app-action-list">
			...
			<?php }else{ ?>
				...
				<div class="vw-mobile-app-pattern-page">
					...
					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','vw-mobile-app'); ?></span></b></p>
	              	<div class="vw-mobile-app-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-woocommerce-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vw-mobile-app'); ?></a>
			    	</div>
	              	<p><?php esc_html_e('You can create a template as you like.','vw-mobile-app'); ?></span></p>
			    </div>
			<?php } ?>
		</div>
