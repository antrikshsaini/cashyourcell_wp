jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_mobile_app_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-mobile-app-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-mobile-app-plugin-install');
                button.addClass('button-primary vw-mobile-app-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-mobile-app-recommended-plugins .vw-mobile-app-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-mobile-app-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-mobile-app-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-mobile-app-recommended-plugins').css('display','none');
    });
