...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|medium"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--medium)"><!-- wp:post-title {"textAlign":"center","level":1} /-->
...
<!-- /wp:group -->
<!-- wp:post-featured-image {"height":"432px"} /--></div>
<!-- /wp:group -->
